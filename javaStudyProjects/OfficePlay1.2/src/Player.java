...
public class Player extends Frame {
	...
	public static int PLAYER_WIDTH = 800;
	public static int PLAYER_HEIGHT = 600;
	Image img = null;
	Parser parser = null;
	...
	public void lauchFrame(){
		PLAYER_WIDTH = graphicConf.getBounds().width;
		PLAYER_HEIGHT = graphicConf.getBounds().height;
		this.setTitle("Player");
		this.setBounds(graphicConf.getBounds());
