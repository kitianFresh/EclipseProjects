...
public class HideFrame extends JFrame implements ActionListener{
	...
	public HideFrame(){
		...
		setSize(400, 300);
                ...
                textarea_out.append("Html");
                this.add(textarea_out);
		setUndecorated(true);
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		} else if ((frameTop > -5 && frameTop < 5) && (frameLeft > -5 && frameLeft < 5) && !(isPtInRect(rect, 
...
point))) {
		...
		} else if ((frameRight > -5 && frameRight < 5) && (frameTop > -5 && frameTop < 5) && !(isPtInRect(rect, 
